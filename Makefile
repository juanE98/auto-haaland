...
API_ENDPOINT ?= https://lp9xqz3bs1.execute-api.ap-southeast-2.amazonaws.com/dev
STATE_MACHINE_ARN ?= arn:aws:states:ap-southeast-2:198564310665:stateMachine:fpl-pipeline-dev
top:
ifndef GW
